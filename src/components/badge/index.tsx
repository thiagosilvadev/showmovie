...
export const Badge = ({ rating, className }: BadgeProps) => {
  const classname = classNames(
    'absolute top-4 left-4 text-[#ffad49] flex p-2 py-3 justify-center items-center gap-1 bg-black/60 rounded-lg backdrop-blur text-base font-secondary',
    className
  )
  return (
